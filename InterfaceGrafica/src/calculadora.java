	...
	public calculadora() {
		...
		sub1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//APRESENTAR A RESPOSTA//
				JOptionPane.showMessageDialog(null, "A subtraçao dos dois números é: " +sub, "Resultado Subtração",  JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		multi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//APRESENTAR A RESPOSTA//
				JOptionPane.showMessageDialog(null, "A multiplicação dos dois números é: " +multi, "Resultado Multiplicação",  JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		div.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (numero1 == 0) {
					...
					JOptionPane.showMessageDialog(null, "Não possivel dividir qualquer número por 0" ,"Erro",  JOptionPane.INFORMATION_MESSAGE);
				}else{
					div = numero1 / numero2;
					JOptionPane.showMessageDialog(null, "A divisão dos dois números é: " +div, "Resultado Divisão",  JOptionPane.INFORMATION_MESSAGE);
				};	
			}
		});
